...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<ProductItemEntity> products)
    : _products = products;
...
abstract class _Success implements FavoriteState {
  const factory _Success(final List<ProductItemEntity> products) =
      _$SuccessImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'FavoriteState.error(errMessage: $errMessage)';
  }
